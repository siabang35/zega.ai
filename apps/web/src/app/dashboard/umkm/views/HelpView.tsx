...
import { 
  ...
  Plus, Maximize2, Minimize2, History, ArrowLeft, ChevronRight, Trash2, Copy, Check
} from 'lucide-react';
...
export const HelpView: React.FC = () => {
  ...
  const handleCopyHelpMessage = (text: string, msgId: string) => {
    try {
      ...
      triggerToast('✓ Pesan tersalin ke clipboard');
              ...
              {chatMessages.map((msg, idx) => (
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <button
                      type="button"
                      onClick={() => handleCopyHelpMessage(msg.message, msg.id || `help-msg-${idx}`)}
                      ...
                      title="Salin Pesan"
                    >
                      {copiedHelpMsgId === (msg.id || `help-msg-${idx}`) ? (
